...
class AdvertismentController extends AppBaseController
{
    ...
    public function __construct(AdvertismentRepository $repository)
    {
        $this->repo = $repository;
        $this->gender = 'M';
        $this->model = 'advertisment';
        $this->modelPlural = 'advertisments';
        $this->modelSpanish = 'aviso';
        $this->modelSpanishPlural = 'avisos';
