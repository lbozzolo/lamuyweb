...
//            'url_pdf' => ($magazine->url_pdf)? (string)url(storage_path('app/'.$magazine->url_pdf)) : null,
            'url_cover' => ($magazine->url_cover)? (string)url('storage/app/covers/'.$magazine->url_cover) : null,
//            'url_cover' => ($magazine->url_cover)? (string)url(storage_path('app/covers/'.$magazine->url_cover)) : null,
        ];
    }
}
